                ...
                <div class="row">
                    @if ($index % 2 == 0)
                        <div class="left col-sm-12 col-md-6">
                            ...
                            {!! \Str::limit($solution->translate(locale())->description, 250) !!}
                            <a href="{{ route('site.solution', ['solution' => $solution->slug]) }}" class="btn-3">
                        ...
                        <div class="right ez-animate col-sm-12 col-md-6" data-animation="fadeIn">
                            <img class="img-fluid" src="{{ $solution->image_path }}" alt=""
